	...
	try {
		...
		if (anu.action == 'add') {
			...
			try {
				...
				sendButImage(anu.jid, teks, `Miyuki DVT`, img,but = [{buttonId:`getdescgc`, 
			...
			try {
				...
				sendButImage(anu.jid, teks, `Miyuki DVT`, img,but = [{buttonId: `Hello World!`, buttonText: {displayText: `GOODBYE !!`}, type: 1}], options = {contextInfo: {mentionedJid: [num, htod]}})
